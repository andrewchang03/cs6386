...
def forget(data, i, g, k, norms, index, stats):
    """
    naive serial replication of caboose unlearning algorithm
    """
...
def ground_truth(data, i, g, k):
    """
    get ground truth unlearned index
    """
    data[i, g] = 0
...
def index_equal(index1, index2, eps=0.01):
    """
    Check if [index1] and [index2] are equal, down to heaps
    """
    counter = 0
...
def compare(data, r, c, k, stats):
    """
    Compare actual index and caboose unlearned index
    """
